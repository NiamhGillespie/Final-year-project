...
class UpdateStoryForm extends Component {
    ...
    displayEpics() {
        ...
        for (var i = 0; i < epics.length; i++) {
            returnList.push(
                {title: epics[i].title, id: epics[i].epic_id}
            )
        }
    ...
    currentEpic() {
        ...
        for (var i = 0; i < epics.length; i++) {
                if (epics[i].epic_id == epic) {
                    returnList.push(
                        {title: epics[i].title, id: epics[i].id}
                    )
                }
        }
    ...
    render() {
        ...
        <Form onSubmit={ this.updateStory }>
            ...
            <ModalBody className="mt-0 mb-0">
                <div className="details-left-col float-left" style={{ borderRight: '2px solid #' + this.props.epic_colour + '60'}}>
                        ...
                        <p className="details-box-header" style={{ backgroundColor: '#' + this.props.epic_colour}}> User story </p>
                            <FormGroup>
                                <Input
                                    ...
                                    style={{ backgroundColor: '#' + this.props.epic_colour + '40',  scrollbarColor: '#' + this.props.epic_colour + '90  #' + this.props.epic_colour + '30'}}
                                />
                            </FormGroup>
                    </div>
                    ...
                    <div className="story-details-values-box h-100 mt-0 mb-0"> 
                        ...
                        <FormGroup>
                            ...
                            name="values" 
                            className='ms-2 w-75' 
                            style={{ chips: { background: '#' + this.props.epic_colour }, searchBox: { border: "none", "border-bottom": "1px solid blue", "border-radius": "0px" }} }
                ...
                <Button className="details-edit-button" style={{border: '2px solid #' + this.props.epic_colour, color: '#' + this.props.epic_colour}}> update </Button>

                    <div className="story-details-values-box h-100 mt-0 mb-0"> 
                        <p className="details-stories-header" style={{ color: '#' + this.props.epic_colour}}> Tags: </p>
    
                        <FormGroup>
                            <Multiselect options = { this.displayTeamTags() } 
                    ...
                    <div className="mt-3"> 
                        <p style={{ color: '#' + this.props.epic_colour}} className="details-heading mb-1"> Epic: </p>

                        <FormGroup>
                            <Multiselect options = { this.displayEpics() } 
                            onSelect={this.onEpicAdd} 
                            //onRemove={this.onEpicDeletion}
                            singleSelect
                            name="epic_id" 
                            className='ms-2 w-75' 
                            style={{ chips: { background: '#' + this.props.epic_colour, color: 'white'}, searchBox: { border: "none", "border-bottom": "1px solid blue", "border-radius": "0px" }} }
                    ...
                    <div className="mt-3"> 
                        <p style={{ color: '#' + this.props.epic_colour}} className="details-heading mb-1 d-inline">Pairable: </p>
                    ...
                    <div className="mt-3"> 
                        <p style={{ color: '#' + this.props.epic_colour}} className="details-heading mb-1">Assigned to: </p>
                        <FormGroup>
                            <Input
                                type="text"
                                name="assigned_to"
                    ...
                    <div className="mt-3"> 
                        <p style={{ color: '#' + this.props.epic_colour}} className="details-heading mb-1">Priority: </p>
                        <FormGroup>
                            <select value={this.state.value} onChange={this.onChange} name="priority" className='ms-2'  style={{ border: '2px solid #' + this.props.epic_colour}}>
