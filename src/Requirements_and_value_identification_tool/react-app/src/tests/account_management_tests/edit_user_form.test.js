...
import EditUserForm from '../../components/account_management/edit_user_form.js';
...
test('Loads form fields properly', async () => {
    const { getByText } = render(<EditUserForm user={user} toggle={toggleModal} />);
    ...
    const password_exists = getByText('Password:');
